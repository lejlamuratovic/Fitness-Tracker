...
const schema = yup.object({
  ...
  newPassword: yup.string().nullable().test(
...
const EditInfoModal = ({ open, handleClose, user, setUser, onSuccess }: EditInfoModalProps) => {
  ...
  const onSubmit = (formData: UserInfoData) => {
    ...
    if (formData.oldPassword && formData.newPassword) {
      const password = { newPassword: formData.newPassword, oldPassword: formData.oldPassword };
