        ...
        <Container maxWidth="xs">
            ...
            >
                <Box sx={modalStyle} component="form" onSubmit={handleSubmit(onSubmit)}>
                    <Typography variant="h5" color="text.secondary" textAlign="center"> Edit Exercise </Typography>
                    <TextField
                        label="Exercise Name"
                    ...
                    <FormControl fullWidth margin="normal">
                        ...
                        >
                            {Object.values(MuscleGroups).map((group) => (
                                <MenuItem key={group} value={group} defaultValue={exercise.muscleGroup}>
                                    {group}
                                </MenuItem>
                            ))}
                        </Select>
                    ...
                    { selectedFile && <Typography sx={{ color: 'text.secondary' }}>{selectedFile}</Typography>}
